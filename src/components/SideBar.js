...
const SideBar = () => {
  return (
    <div className="fixed h-full w-1/6 bg-slate-800">
      <div className="flex items-center justify-between m-2 p-2">
        <div className="mr-1">
          <img
            ...
            alt="Logo"
            className="h-12 rounded-sm mr-2"
          />
        </div>
        <div className="text-white flex flex-col mr-5">
          <h1 className="text-xl mb-3 mt-2">Nishyan</h1>
      ...
      <div className="m-4 text-white mt-5">
        <button className="flex items-center text-gray-300 my-5">
          <FontAwesomeIcon icon={faHome} className="mr-4" />
          <h1>Home</h1>
        </button>
        <button className="flex items-center mb-2 text-gray-300 my-5">
          <FontAwesomeIcon icon={faClipboardList} className="mr-4" />
          <h1>Orders</h1>
        </button>
        <button className="flex items-center mb-2 text-gray-300 my-5">
        ...
        <div className="flex bg-slate-600 p-2 rounded-lg -ml-2">
        ...
        <button className="flex items-center mb-2 text-gray-300 my-5">
          <FontAwesomeIcon icon={faTags} className="mr-4" />
          <h1>Discounts</h1>
        </button>
        <button className="flex items-center mb-2 text-gray-300 my-5">
